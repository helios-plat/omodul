    ...
    try:
        ...
        if config.clean_noise:
            ...
            record_step(
                ...
                on_step=on_step,
                layer="oprim",
                callable_name="text_clean_publish_noise",
        ...
        record_step(
            ...
            on_step=on_step,
            layer="oprim",
            callable_name="markdown_frontmatter_build",
        ...
        step_start = datetime.now(UTC)
        title_slug = input_data.metadata.get("title", config.substrate_id).replace(" ", "_")[:40]
