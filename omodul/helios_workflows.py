...
def key_moment_traversal(
    config: KeyMomentConfig,
    input_data: dict,
    output_dir: Path,
    *,
    on_step: Callable[[dict], None] | None = None,
...
def alert_personalization(
    config: AlertPersonalizationConfig,
    input_data: dict,
    output_dir: Path,
    *,
    on_step: Callable[[dict], None] | None = None,
...
def abstain_aware_recommendation(
    config: AbstainRecommendationConfig,
    input_data: dict,
    output_dir: Path,
    *,
    on_step: Callable[[dict], None] | None = None,
    ...
    def _recommend(d: dict) -> dict:
        ...
        return {
            "recommendation": "buy" if score > 20 else "sell" if score < -20 else "hold",
