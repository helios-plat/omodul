...
from oskill.cold_start_single import ColdStartInput, cold_start_single
    ...
    *,
    ...
    try:
        ...
        return standard_return(
            findings=cs_res, status="success", fingerprint=fp, trail=trail, cost_usd=cost_usd
        )

    except Exception as e:
        trail.append({"event": "error", "message": str(e)})
        return standard_return(
            findings=None, status="failed", error=str(e), trail=trail, cost_usd=0.0
        )
