...
from oprim import bash_exec, file_read, file_write
    ...
    *,
    ...
    try:
        ...
        for iteration in range(config.max_iterations):
            ...
            if on_step:
                on_step(
                    {"event": "failed", "iteration": iteration, "code": result.code}
                )  # pragma: no cover
            ...
            response = await llm_call(
                ...
                event=f"fix_iteration_{iteration}",
            )
            ...
            for edit in edits:
                ...
                try:  # pragma: no cover
                    ...
                    if fixed.ok:  # pragma: no cover
                        ...
                        trail.record(
                            event="fix_applied", path=path, iteration=iteration
                        )  # pragma: no cover
