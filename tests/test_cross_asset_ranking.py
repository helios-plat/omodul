...
from omodul.cross_asset_opportunity_ranking import (
    CrossAssetRankingConfig,
    cross_asset_opportunity_ranking,
)
...
def test_basic(tmp_path):
    ...
    inp = {
        ...
        "fusion_histories": {
            "BTC": list(range(40, 80)),
            "Gold": list(range(30, 80)),
            "ETH": list(range(35, 70)),
        },
    }
...
def test_report_generated(tmp_path):
    ...
    r = cross_asset_opportunity_ranking(
        c, {"fusion_scores": {"A": 80}, "fusion_histories": {"A": list(range(50, 90))}}, tmp_path
    )
